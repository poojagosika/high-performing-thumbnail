...
const TEMPLATES = [
  {
    ...
    slots: [
      ...
      },
      {
        ...
        cutout: true,
        z: 2,
        rect: { x: 0.6, y: 0.04, w: 0.4, h: 0.96 },
      },
      {
        key: "headline",
        label: "Headline",
        type: "text",
        z: 3,
        rect: { x: 0.2, y: 0.03, w: 0.6, h: 0.3 },
        defaults: { text: "", font: "anton", color: "#FFFFFF", strokeColor: "#000000", scale: 0.16 },
      },
    ],
  },
  {
